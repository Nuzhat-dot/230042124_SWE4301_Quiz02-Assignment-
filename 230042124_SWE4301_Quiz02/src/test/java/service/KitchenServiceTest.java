...
import org.example.model.OrderPriority;
...
public class KitchenServiceTest {
    ...
    private org.example.model.Order order;  // Fully qualified to avoid conflict with JUnit's @Order
    ...
    void setUp() {
        ...
        order = new org.example.model.Order(1, customer);
